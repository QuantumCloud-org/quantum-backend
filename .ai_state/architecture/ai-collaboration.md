...
更新: 2026-07-06 (sprint: 2026-07-06-ai-capability-architecture-design)
...
| 运行期 (runtime): 外部 Agent 经 MCP 按操作者身份读业务数据 | `project-data-reader` skill + `quantum-mcp` 模块 (S3) | 设计定案, 待实现 |
