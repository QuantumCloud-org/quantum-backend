...
VALUES
    -- 一级菜单
    (1, 0, '系统管理', 'system', NULL, '', 'system', 'M', 1, 1, 1),
    (2, 0, '系统监控', 'monitor', NULL, '', 'monitor', 'M', 2, 1, 1),

    -- 系统管理子菜单
    (100, 1, '用户管理', 'user', 'system/user/index', 'system:user:list', 'user', 'C', 1, 1, 1),
    (101, 1, '角色管理', 'role', 'system/role/index', 'system:role:list', 'peoples', 'C', 2, 1, 1),
    (102, 1, '菜单管理', 'menu', 'system/menu/index', 'system:menu:list', 'tree-table', 'C', 3, 1, 1),
    (103, 1, '部门管理', 'dept', 'system/dept/index', 'system:dept:list', 'tree', 'C', 4, 1, 1),
    ...
    (201, 2, '操作日志', 'operlog', 'monitor/operlog/index', 'monitor:operlog:list', 'form', 'C', 2, 1, 1),
    (202, 2, '登录日志', 'loginlog', 'monitor/loginlog/index', 'monitor:loginlog:list', 'logininfor', 'C', 3, 1, 1),
    (203, 2, '缓存监控', 'cache', 'monitor/cache/index', 'monitor:cache:list', 'redis', 'C', 4, 1, 1),
    (204, 2, '服务监控', 'server', 'monitor/server/index', 'monitor:server:list', 'server', 'C', 5, 1, 1),
